...
document.addEventListener('DOMContentLoaded', () => {
  ...
  ════════════════════════════════════════════ */
/* ════════════════════════════════════════════
     4. PLAY BUTTON — Open Video / Iframe in New Tab
     ════════════════════════════════════════════ */
  allItems.forEach(item => {
    const playBtn = item.querySelector('.play-icon');
    const video   = item.querySelector('video');
    const iframe  = item.querySelector('iframe'); // Grab iframe if it exists
    ...
    if (playBtn) {
      playBtn.addEventListener('click', (e) => {
        ...
        // Handle Google Drive iframe elements
    ...
    // Pause/play local video on item hover for performance
